...
/*
	...
	Thank you!
*/
g_jsDatePickImagePath = "uploads/calendar/img/";
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.cellColorScheme = (aConf["cellColorScheme"] != null) ? aConf["cellColorScheme"] : "orange";
	this.oConfiguration.dateFormat		= (aConf["dateFormat"] != null) ? aConf["dateFormat"] : "%m-%d-%Y";
	this.oConfiguration.imgPath			= (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "uploads/calendar/img/";
	...
	if (this.oConfiguration.useMode == 2){
		if (this.oConfiguration.target != false){
			if (typeof(JsgetElem(this.oConfiguration.target)) != null){
				...
				JsDatePickBox.style.top = "-12px";
				JsDatePickBox.style.left = "324px";
