...
class XTemplate_original {
     ...
     * @return XTemplate
     */
	public function __construct($options, $tpldir = '', $files = null, $mainblock = 'main', $autosetup = true, $skipPath=FALSE) {

		# ImeiUnlock
		if($skipPath != TRUE && !is_array($options)) {
			$options = "skins".CC_DS. SKIN_FOLDER .CC_DS."styleTemplates".CC_DS.$options;
		}
		# ImeiUnlock
	...
	public function assign ($name, $val = '', $reset_array = true) {
		...
		$this->vars['VAL_SKIN'] = SKIN_FOLDER;
    ...
    */
	...
	public function text ($bname = '') {
		...
		# ImeiUnlock
		include_once(CC_ROOT_DIR.CC_DS."includes".CC_DS."sef_urls.inc.php");	
		$text = sef_rewrite_urls($text);
		# ImeiUnlock
