...
<?php
if (!isset($_GET['mode'])) {
	$url = (permission("products","write") == true) ? 'href="?_g=repair/emailContent&amp;mode=new&amp;parent='.$_GET['parent'].'" class="txtLink"' : $link401;
...
<span class="catid">
  ...
  <div class="action2">
	<div class="right2" style="margin-right:60px;"><?php
		$url = (permission("products","edit")) ? 'href="?_g=repair/emailContent&amp;edit='.$results[$i]['id'].'" class="txtLink"' : $link401;
	...
	<?php if ($i >= 1) { ?>
	  <a href="?_g=repair/emailContent&amp;move=<?php echo $results[$i]['id']; ?>&amp;to=<?php echo $i-1; ?>&amp;parent=<?php echo $results[$i]['cat_father_id']; ?>&amp;dir=up">
	  <img src="<?php echo $glob['rootRel']; ?>images/admin/arrow_up.gif" border="0" /></a>
	<?php  } ?>
	<?php if ($i < $count) { ?>
	  <a href="?_g=repair/emailContent&amp;move=<?php echo $results[$i]['id']; ?>&amp;to=<?php echo $i+1; ?>&amp;parent=<?php echo $results[$i]['cat_father_id']; ?>&amp;dir=down">
...
<form action="?_g=repair/emailContent" method="post" enctype="multipart/form-data" name="form1">
