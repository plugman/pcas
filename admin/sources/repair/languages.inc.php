...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <?php if($_GET["mode"]!=="new"){ ?><td align="right" valign="middle"><a <?php if(permission("documents","write")==TRUE){?>href="<?php echo $glob['adminFile']; ?>?_g=repair/languages&amp;mode=new&amp;prod_master_id=<?php echo $_GET['prod_master_id']; ?>" class="txtLink"<?php } else { echo $link401; } ?>><img src="<?php echo $glob['adminFolder']; ?>/images/buttons/new.gif" alt="" hspace="4" border="0" title="" /><?php echo $lang['admin_common']['add_new'];?></a></td><?php } ?>
...
<form action="<?php echo $glob['adminFile']; ?>?_g=repair/languages&amp;prod_master_id=<?php echo $_GET['prod_master_id']; ?>" target="_self" method="post" language="javascript">
...
<?php
	...
	<table width="100%"  border="0" cellspacing="1" cellpadding="3" class="mainTable">
	  ...
	  <tr>
		...
		<a <?php if(permission("documents","edit")==TRUE){ ?>href="<?php echo $glob['adminFile']; ?>?_g=repair/languages&amp;edit=<?php echo $results[$i]['id']; ?>&amp;prod_master_id=<?php echo $_GET['prod_master_id']; ?>" class="txtLink"<?php } else { echo $link401; } ?> ><?php echo $lang['admin_common']['edit'];?></a>
		...
		<a <?php if(permission("documents","delete")==TRUE){ ?>href="<?php echo $glob['adminFile']; ?>?_g=repair/languages&amp;delete=<?php echo $results[$i]['id']; ?>&amp;prod_master_id=<?php echo $_GET['prod_master_id']; ?>" onclick="return confirm('<?php echo str_replace("\n", '\n', addslashes($lang['admin_common']['delete_q'])); ?>')" class="txtLink" <?php } else { echo $link401; } ?>><?php echo $lang['admin_common']['delete'];?></a>
