...
?>
<p><a href="http://www.nochex.com/" target="_blank"><img src="modules/gateway/Nochex_APC/admin/logo.gif" alt="" border="0" title="Nochex" /></a></p><br />
...
?>
<p class="copyText">This gateway module is designed to work with the latest seller and merchant facilities offered by Nochex.</p><br />
...
<div class="headingBlackbg">Global Configuration Settings</div>
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="mainTable">

  <tr>
    <td width="20%" align="left" class="tdText"><strong>Status:</strong><br/>
  ...
  <tr>
    ...
    <td class="tdText"><select class="textbox5" name="module[accType]">
  ...
  Include your website header &amp; footer in the Nochex <br/>Payments Page (merchant accounts only!)</td>
      <td class="tdText">
	<select class="textbox5" name="module[passTemplate]">
  ...
  <tr>
    <td align="right" colspan="2" class="tdText"><input type="submit" class="submit" value="Save Config" /></td>
  </tr>
</table>
</form>