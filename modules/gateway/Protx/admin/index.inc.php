...
<p><a href="http://www.sagepay.com/"><img src="modules/<?php echo $moduleType; ?>/<?php echo $moduleName; ?>/admin/logo.gif" alt="" border="0" title="" /></a></p><br />
...
?>
<p class="copyText">&quot;Securing the future of eCommerce.&quot;</p><br />
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="mainTable">
  ...
  <td align="left" class="tdText"><strong>Encryption Passphrase:</strong></td>
   ...
   <tr>
     ...
     <td class="tdText"><select class="textbox5" name="module[gate]">
