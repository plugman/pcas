...
?>
<p><a href="http://www.cubecart.com/moneybookers" target="_blank"><img src="modules/<?php echo $moduleType; ?>/<?php echo $moduleName; ?>/admin/logo.gif" alt="" border="0" title="" /></a></p><br />

<p class="copyText">&quot;And money moves .&quot;</p><br />

<p>To have access to the international payment network of Moneybookers please <a href='https://www.moneybookers.com/app/register.pl' class="txtLink">register here</a> for a free account if you don’t have one yet.</p> More information can be found <a href='http://www.moneybookers.com/partners/cubecart/' class='txtLink'>here</a>.<br />
...
if($no_cust_id){
?>
<p class='warnText'>It appears that you haven't opened a Moneybookers account yet. Please register one <a href='https://www.moneybookers.com/app/register.pl' class='txtLink'>here</a>. This module cannot be enabled until your moneybookers email address has been verified.</p><br />
...
?>
<p class='infoText'>You are now ready to use all direct payment options of Moneybookers – please set the module status on enabled.</p><br />

<?php	
} elseif(isset($accountPass) && !$accountPass){
?>
<p class='warnText'>Your moneybookers secret word could not be verified. Please choose a secret word in the Merchant Tools section of your Moneybookers account and submit it in the section below.</p><br />

<?php
}
if(isset($emailVerifiedFirst) && $emailVerifiedFirst){
?>
<p class='warnText'>Quick Checkout cannot be activated until your email address has been verified.</p><br />
...
<br /><br />
Attention: The secret word should be different from your password.  Please make sure you enter your secret word in the Merchant Tools section of your Moneybookers account first.</p><br />
...
<tr>
    <td  colspan="2" class="tdTitle headingBlackbg"><strong>Activate Quick Checkout</strong></td>
  </tr>
  <tr>
  <?php
