...
<p><a href="http://www.authorize.net/"><img src="modules/<?php echo $moduleType; ?>/<?php echo $moduleName; ?>/admin/logo.gif" alt="" border="0" title="" /></a></p><br />
...
?>
<p class="copyText">&quot;Your Gateway to IP Transactions.&quot;</p><br />
...
<table border="0" cellspacing="1" cellpadding="3" class="mainTable">
  <tr>
    ...
    <td class="tdText">
	<select class="textbox5" name="module[reqCvv]">
  ...
  <td align="left" class="tdText"><strong>Password:</strong><br/>Only required if  Password-Required Mode is enabled. </td>
   ...
   <tr>
     ...
     <td class="tdText"><select class="textbox5" name="module[debug]">
