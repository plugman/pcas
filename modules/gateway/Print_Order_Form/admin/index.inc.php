...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class="mainTable">
  ...
  <tr>
    ...
    <td class="tdText">
	<select class="textbox5" name="module[multiCurrency]">
  ...
  <tr>
   ...
   <tr>
     ...
     <td class="tdText">
	 <select class="textbox5" name="module[cheque]">
   ...
   <tr>
     ...
     <td class="tdText"><select class="textbox5" name="module[card]">
  ...
  <td align="left" class="tdText"><strong>Cards Accepted:</strong><br />
    ...
    <tr>
      ...
      <td class="tdText"><select class="textbox5" name="module[bank]">
    ...
    <tr>
      ...
      <td class="tdText"><textarea class="textarea3" name="module[address]" cols="30" rows="5"><?php echo $module['address']; ?></textarea></td>
    </tr>
    <tr>
      <td align="left" valign="top" class="tdText"><strong>Notes to Customer: </strong></td>
      <td class="tdText"><textarea class="textarea3" name="module[notes]" cols="30" rows="5"><?php echo $module['notes']; ?></textarea></td>
    </tr>
    <tr>
