...
<p><a href="http://www.eway.com.au/"><img src="modules/<?php echo $moduleType; ?>/<?php echo $moduleName; ?>/admin/logo.gif" alt="" border="0" title="" /></a></p><br />


<p class="copyText">&quot;e-commerce the easy way.&quot;</p><br />
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <tr>
    ...
    <td class="tdText">
	<select class="textbox5" name="module[test]">
