...
class EwayPayment {
    ...
    function doPayment() {
        ...
        $xmlRequest = "<ewaygateway>".
                ...
                "<ewayCustomerFirstName><![CDATA[".htmlentities( $this->myCustomerFirstname )."]]></ewayCustomerFirstName>".
                "<ewayCustomerLastName><![CDATA[".htmlentities( $this->myCustomerLastname )."]]></ewayCustomerLastName>".
                "<ewayCustomerEmail><![CDATA[".htmlentities( $this->myCustomerEmail )."]]></ewayCustomerEmail>".
                "<ewayCustomerAddress><![CDATA[".htmlentities( $this->myCustomerAddress )."]]></ewayCustomerAddress>".
                "<ewayCustomerPostcode><![CDATA[".htmlentities( $this->myCustomerPostcode )."]]></ewayCustomerPostcode>".
                ...
                "<ewayCardHoldersName><![CDATA[".htmlentities( $this->myCardHoldersName )."]]></ewayCardHoldersName>".
