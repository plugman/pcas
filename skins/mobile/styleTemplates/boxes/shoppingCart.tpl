...
<a href="index.php?_g=co&amp;_a={CART_STEP}"  id="basketbox">
<span class="totalitems">{VAL_CART_ITEMS}</span></a> 
<!-- BEGIN: view_cart -->
<!--<a href="#cart-box" class="login-window" id="basketbox"><span class="cat"> {LANG_VIEW_CART}</span></a>-->
<!-- END: view_cart -->
