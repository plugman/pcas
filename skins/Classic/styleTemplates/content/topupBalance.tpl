...
<div class="maindiv breadbg">
  <div class=" maincenter"> <a href="index.php"><img alt="" src="skins/{VAL_SKIN}/styleImages/home3.jpg" /></a> / 
   {LANG_TOPUP_YOUR_BALANCE_TITLE}</div>
</div>
        ...
        <div class="maindiv">
          <form action="{URI_TOPUP}" target="_self" method="post" id="frmPayment" name="frmPayment">
            ...
            <div class="inputamount">
              ...
              <div class="paynow">
                <input name="submitPaymentOption" type="submit" value="Pay Now " class="submitlogin button radius3px" style="width:auto"  />
                <p class="txt-darkpurple txt13"style="font-weight: bold;">3.5% PayPal Processing Fee *</p>
              </div>
            </div>
          </form>
          <div class="topupbaldetail">
            <h1 class="yourbal">Current Balance</h1>
            <div class="maindiv">
