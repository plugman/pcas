...
{JS_COUNTY_OPTIONS}
  ...
  <div class=" maincenter"> <a href="index.php">Home</a><span class="breadSeprator"></span> My Account
     </div>
</div>
        ...
        <div class="maindiv">
     	...
     	<div class="maindiv">
           <label class="txt14 txt-grey maindiv">Image</label>
       		<div class="txtboxmain">
             <div class="imgbox">  <img alt="pic" id="my_image" src="{USER_IMAGE}" class="myimg" /></div>
...
/*	var filename1 =  src.substr(fileNameIndex);
   ...
   var dataval = userfolder+"||"+filename ;
    $.ajax({
        type: "POST",
        url: storeUrl + "ajax/updateprofileimage.php",
