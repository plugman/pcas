...
function addtimerow(parent, quantity) {
	...
	for (i=0; i<qty; i++) {
		...
		newRow.innerHTML = '<td   width="3%"><a href="" onclick="return delRow(\'orderRow_'+rowCount+'\')"><img src="admin/images/del.gif" alt="" /></a></td><td  class="tdText" width="15%"><select name="day[]"><option value="1">Monday</option><option value="2">Tuesday</option><option value="3">Wednessday</option><option value="4">Thursday</option><option value="5">Friday</option><option value="6">Saturday</option><option value="7">Sunday</option></select></td><td  class="tdText" width="6%">From</td><td  valign="left" width="25%"><input type="text" id="time3" size="10" value="12.00 PM" class="textbox" onclick="updatetime();" name="from[]"/></td><td  class="tdText" width="6%">To</td><td  valign="left" width="25%"><input type="text" id="time4" size="10" value="01.00 PM" class="textbox" onclick="updatetime();" name="to[]"/><input type="hidden" id="rowCount" value="1" /><input type="hidden" name="count[]" value="" /></td>';
		rowCount++;
	}
