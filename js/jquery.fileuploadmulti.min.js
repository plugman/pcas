  ...
  //  a.fileapi = b("<input type='file'/>").get(0).files !== undefined;
    ...
    b.fn.uploadFile = function (t) {
        ...
        var r = b.extend({
            ...
            dragDropStr: "<span>Drop your pictures here! <br>OR</span>",
        ...
        function f(w, u, v) {
            ...
            v.on("dragenter", function (s) {
                ...
                b(this).css("border", "1px solid #000000")
		...
		y.formData.user = $('#ccuser').val();  // set user folder or sesion
            var x = null;
